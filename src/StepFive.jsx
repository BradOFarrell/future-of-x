...
class StepFive extends React.Component {
  ...
  paintNewspaper() {
    ...
    backgroundImg.src = require("./newspaper"+this.state.articleType+".png");
  ...
  paintBody(context, hiddenContext, body) {
    ...
    hiddenContext.font = "22px Times New Roman";

    if (bodyArray != null) {
      bodyArray.forEach(bodyWord => {
        if (!bodyLineOneClosed) {
          if (context.measureText(bodyLineOne + bodyWord + " ").width > 310) {
        ...
        if (!bodyLineTwoClosed) {
          if (context.measureText(bodyLineTwo + bodyWord + " ").width > 310) {
        ...
        if (!bodyLineThreeClosed) {
          if (context.measureText(bodyLineThree + bodyWord + " ").width > 365) {
        ...
        if (!bodyLineSixClosed) {
          if (context.measureText(bodyLineSix + bodyWord + " ").width > 250) {
        ...
        if (!bodyLineSevenClosed) {
          if (context.measureText(bodyLineSeven + bodyWord + " ").width > 250) {
        ...
        if (!bodyLineEightClosed) {
          if (context.measureText(bodyLineEight + bodyWord + " ").width > 250) {
        ...
        if (!bodyLineNineClosed) {
          if (context.measureText(bodyLineNine + bodyWord + " ").width > 250) {
        ...
        if (!bodyLineTenClosed) {
          if (context.measureText(bodyLineTen + bodyWord + " ").width > 250) {
        ...
        if (!bodyLineElevenClosed) {
          if (context.measureText(bodyLineEleven + bodyWord + " ").width > 250) {
        ...
        if (!bodyLineTwelveClosed) {
          if (context.measureText(bodyLineTwelve + bodyWord + " ").width > 250) {
    ...
    if (bodyLineSix != '') {
      context.fillText(bodyLineSix, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineSix, bodyX+250, bodyY);

      bodyY += bodyYModifier;
    }

    if (bodyLineSeven != '') {
      context.fillText(bodyLineSeven, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineSeven, bodyX+250, bodyY);

      bodyY += bodyYModifier;
    }

    if (bodyLineEight != '') {
      context.fillText(bodyLineEight, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineEight, bodyX+250, bodyY);

      bodyY += bodyYModifier;
    }

    if (bodyLineNine != '') {
      context.fillText(bodyLineNine, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineNine, bodyX+250, bodyY);

      bodyY += bodyYModifier;
    }

    if (bodyLineTen != '') {
      context.fillText(bodyLineTen, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineTen, bodyX+250, bodyY);

      bodyY += bodyYModifier;
    }

    if (bodyLineEleven != '') {
      context.fillText(bodyLineEleven, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineEleven, bodyX+250, bodyY);
      
      bodyY += bodyYModifier;
    }

    if (bodyLineTwelve != '') {
      context.fillText(bodyLineTwelve, bodyX+250, bodyY);
      hiddenContext.fillText(bodyLineTwelve, bodyX+250, bodyY);
    }
  }
